...
<div class="min-h-screen bg-[#F6F9FF]">
    <nav class="bg-gradient-to-b from-[#0B1B43]/95 via-[#162E67]/95 to-[#233876]/95 backdrop-blur-md sticky top-0 z-50 border-b border-white/10">
        <div class="max-w-[1280px] mx-auto px-6 lg:px-12 h-20 flex items-center justify-between" x-data="{ open: false }">
            ...
            <div class="hidden lg:flex items-center gap-7">
                ...
                <a href="/profil" class="text-white font-extrabold text-sm border-b-2 border-white pb-1">Profil</a>
            ...
            <div x-show="open" x-cloak class="absolute top-20 left-0 right-0 bg-[#233876] border-b border-white/10 lg:hidden">
                <div class="px-6 py-4 space-y-2">
                    ...
                    <a href="/profil" class="block px-3 py-2 rounded-xl font-bold text-white bg-white/10">Profil</a>
    ...
    <header class="bg-gradient-to-br from-[#142B63] via-[#233876] to-[#142B63]">
        <div class="max-w-[1280px] mx-auto px-6 lg:px-12 py-10">
            <p class="text-blue-100/80 text-xs font-extrabold uppercase tracking-widest">Profil</p>
        ...
        <div class="max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            <div class="lg:col-span-8 bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
                <div class="p-6 border-b border-slate-100">
                    <p class="text-xs font-extrabold text-slate-400 uppercase tracking-widest">Tentang</p>
                    <p class="mt-2 text-xl font-extrabold text-slate-900">MDMC DIY</p>
                </div>
                <div class="p-6">
            ...
            <aside class="lg:col-span-4 space-y-6">
                <div class="bg-[#142B63] rounded-3xl p-6 text-white shadow-[0_20px_60px_rgba(35,56,118,0.22)]">
                    <p class="text-xs font-extrabold text-blue-100/80 uppercase tracking-widest">Fokus</p>
                    <ul class="mt-4 space-y-3 text-blue-50/95 font-semibold">
                        @foreach($focus as $item)
                            <li class="flex items-start gap-3">
                                <span class="mt-2 w-2 h-2 rounded-full bg-[#4DA8FF]"></span>
                                <span>{{ $item }}</span>
                            </li>
                        @endforeach
                    </ul>
                ...
                <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
                    <div class="p-6 border-b border-slate-100">
                        <p class="text-xs font-extrabold text-slate-400 uppercase tracking-widest">Aksi Cepat</p>
                        <p class="mt-2 text-xl font-extrabold text-slate-900">Butuh informasi?</p>
                    </div>
                    <div class="p-6 grid grid-cols-2 gap-3">
                        <a href="/layanan" class="inline-flex items-center justify-center bg-[#1E66FF] hover:bg-[#175AE2] text-white px-4 py-3 rounded-2xl font-extrabold transition-all shadow-lg shadow-blue-900/15">Layanan</a>
                        <a href="/berita" class="inline-flex items-center justify-center bg-[#F6F9FF] hover:bg-slate-50 text-slate-800 px-4 py-3 rounded-2xl font-extrabold transition-all border border-slate-100">Berita</a>
                    </div>
                </div>
            </aside>
        </div>
