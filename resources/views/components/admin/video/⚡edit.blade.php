...
new class extends Component {
    ...
    public function mount($id)
    {
        ...
        $this->judul = $this->video->judul;
        $this->deskripsi = $this->video->deskripsi;
        $this->video_embed_url = $this->video->video_embed_url;
        $this->bisindo_embed_url = $this->video->bisindo_embed_url;
        $this->is_active = (bool) $this->video->is_active;
    }
    ...
    public function save()
    {
        ...
        $this->dispatch('visual-feedback', message: 'Video berhasil diperbarui!');
...
<div class="max-w-3xl">
    <div class="mb-8">
        ...
        <p class="text-slate-500 text-sm">Ubah data video dan embed BISINDO.</p>
    </div>
    ...
    <form wire:submit="save" class="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 space-y-6">
        ...
        <div class="space-y-2">
            ...
            <input wire:model="video_embed_url" type="text" class="w-full px-5 py-4 rounded-2xl border border-slate-100 bg-slate-50 focus:bg-white focus:ring-4 focus:ring-red-500/10 focus:border-red-500 outline-none transition-all">
        ...
        <div class="space-y-2">
            ...
            <input wire:model="bisindo_embed_url" type="text" class="w-full px-5 py-4 rounded-2xl border border-slate-100 bg-slate-50 focus:bg-white focus:ring-4 focus:ring-red-500/10 focus:border-red-500 outline-none transition-all">
