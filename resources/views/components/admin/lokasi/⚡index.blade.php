...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        ...
        <a href="/lokasi/create" wire:navigate class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-xl font-bold transition-all shadow-lg shadow-red-100 flex items-center gap-2 text-sm">
